...
shared_examples_for 'liqudable' do
  context 'when liquid is present in content' do
    ...
    context 'when message is incoming' do
      ...
      it 'does not process liquid in content' do
    ...
    context 'when message is outgoing' do
      ...
      it 'skips processing broken liquid tags' do
      ...
      it 'does not process liquid tags in multiple code blocks' do
      ...
      it 'does not process liquid tags in single ticks' do
      ...
      it 'does not throw error for broken quotes' do
        message.content = 'hey {{contact.name}} how are you? ` code: {{contact.name}} ` ` code: {{contact.name}} test'
        message.save!
